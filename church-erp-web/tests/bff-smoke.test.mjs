...
test("web baseline contains route shells and BFF boundary files", () => {
  const requiredPaths = [
    ...
    "../src/app/api/secretary/home/route.ts",
    ...
    "../src/features/secretaria/secretary-home.ts",
    "../src/features/communications/communication-template.ts",
    ...
    "../src/components/operational/secretary-home-shell.tsx",
    ...
    "../src/components/operational/people-followup-block.tsx",
    "../src/components/operational/event-schedule-block.tsx",
    "../src/components/operational/communication-pending-block.tsx",
    "../src/components/operational/communication-template-list.tsx",
    "../src/components/operational/weekly-checklist-block.tsx",
