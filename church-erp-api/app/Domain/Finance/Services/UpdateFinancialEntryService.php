...
{
    /**
     * @param  array{church_id: int, entry_type: string, amount: string, financial_category_id: int, counterparty_id: int, cost_center_name: string, reason: string, ip_address: string|null}  $payload
     */
